...
var WebViewBridge = React.createClass({
  ...
  render: function () {
    ...
    if (this.state.viewState === WebViewBridgeState.LOADING) {
      ...
      otherView =
        this.props.renderError && this.props.renderError(errorEvent.domain, errorEvent.code, errorEvent.description)
    ...
    if (this.state.viewState === WebViewBridgeState.LOADING || this.state.viewState === WebViewBridgeState.ERROR) {
